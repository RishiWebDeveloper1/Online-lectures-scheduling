...
const Dashboard = () => {
    ...
    useEffect(() => {
        ...
        navigate(`/admin/${getPage}?user=${encodeURIComponent(username)}`, { replace: true });
    }, [getPage])
    ...
    const redirect = (page) => {
        ...
        navigate(`/admin/${page}?user=${encodeURIComponent(username)}`);
    };
        ...
        <>
            <div className="dashboard-container">
                <aside className="sidebar">
                    ...
                    <ul className="menu">
                        <li className={currentPage === "addCourse" ? "active" : ''} onClick={() => { redirect("addCourse") }}>Create Course</li>
                        <li className={currentPage === "viewCourse" ? "active" : ''} onClick={() => { redirect("viewCourse") }}>View Courses</li>
                        <li className={currentPage === "addLecture" ? "active" : ''} onClick={() => { redirect("addLecture") }}>Add Lectures</li>
                        <li className={currentPage === "viewLecture" ? "active" : ''} onClick={() => { redirect("viewLecture") }}>View Lectures</li>
                        <li className={currentPage === "addUser" ? "active" : ''} onClick={() => { redirect("addUser") }}>Add User</li>
